...
// Contains all 50 questions for the Units & Measurements mock test

const DEFAULT_QUESTIONS = [
  {"id":1,"question":"The dimensional formula [ML²T⁻¹] represents:","options":["Angular momentum","Linear momentum","Energy","Power"],"correctIndex":0,"topic":"Basic Dimensions","difficulty":"Easy","solution":"Angular momentum L = mvr so [M][LT⁻¹][L] = [ML²T⁻¹].","pyqYear":"RRB ALP & Tech. 23.01.2019 Shift-I"},
  ...
  {"id":5,"question":"In the equation E = mc², c² has dimensions:","options":["[L²T⁻²]","[LT⁻¹]","[L²T⁻¹]","[LT⁻²]"],"correctIndex":0,"topic":"Relativity","difficulty":"Easy","solution":"E/m gives [L²T⁻²].","pyqYear":"RRB ALP & Tech. 15.08.2018 Shift-II"},
  ...
  {"id":10,"question":"The dimensional formula [M⁻¹L⁻²T⁴I²] represents:","options":["Inductance","Capacitance","Resistance","Conductance"],"correctIndex":1,"topic":"Electricity","difficulty":"Medium","solution":"C = Q/V gives [IT]/[ML²T⁻³I⁻¹].","pyqYear":"RRB JE CBT-I 22.05.2019"},
